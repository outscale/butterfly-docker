...
LABEL com.outscale.butterfly.version="0.7"
LABEL com.outscale.butterfly.release-date="2017-08-10"

RUN yum update -y && yum install -y libpcap && yum clean all

ADD https://github.com/outscale/butterfly/releases/download/release%2F0.7.0/butterfly_0.7_x86_64.rpm butterfly.rpm
